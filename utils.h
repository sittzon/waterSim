...
void lookAt(float px, float py, float pz,
            ...
            float *m);
void createFBO(unsigned int& fboId);
void createFBOAndBindTexture(unsigned int& fboId, unsigned int& rboId, unsigned int* texId, unsigned int* texId2,const void* texData);
